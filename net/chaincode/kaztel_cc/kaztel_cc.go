...
type Log struct {
    PhoneNumber string `json:"phone_number"`
    Service string `json:"service"`
    Event string `json:"eveht"`
    Status string `json:"status"`  // sent|valid|invalid|expired
...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	cars := []Car{
		Car{Make: "Sldf", Model: "Prius", Colour: "blue", Owner: "Tomoko"},
	...
	users := []User{
		User{PhoneNumber: "9562021515", Name: "Pert", Service: "Mustang", Uin: 223445567},
		User{PhoneNumber: "3562021515", Name: "Maxim", Service: "Peshkov", Uin: 223445565},
	}
...
func (s *SmartContract) createUser(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	var user = User{PhoneNumber: args[1], Name: args[2], Service: args[3]}
